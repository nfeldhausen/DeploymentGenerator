package de.th.bingen.master.backend.helper;

public class RandomWord {
    private static String[] animals = new String[] {"aardvark","albatross","alligator","alpaca","angelfish","anteater","antelope","armadillo","badger","barracuda","bat","beagle","bear","beaver","bird","brontosaurus",
    ...
    private static String[] nouns = new String[] {"apple","baby","back","ball","bear","bed","bell","bird","birthday","boat","box","boy","bread","brother","cake","car","cat","chair","chicken","children","coat","corn",
    ...
    private static String[] adjectives = new String[] {"abrupt","acidic","adorable","adventurous","aggressive","agitated","alert","aloof","amiable","amused","annoyed","antsy","anxious","appalling","appetizing",
    ...
    private static String[] polite_adjectives = new String[] {"adorable","acrobatic","adaptable","adventurous","agile","alert","amiable","amused","arboreal","ardent","artful","astonishing","astute","attentive",
    ...
    /**
     * Creates a random word consisting of an adjective and an animal or noun
     *
     * @return A random word combination
     */
    public static String getRandomWordCombination() {
        StringBuilder result = new StringBuilder();

        if (Math.random() > 0.5) {
            result.append(adjectives[(int)Math.floor(Math.random() * adjectives.length)]);
            result.append("-");
        } else {
            result.append(polite_adjectives[(int)Math.floor(Math.random()*polite_adjectives.length)]);
            result.append("-");
        }

        if (Math.random() > 0.5) {
            result.append(animals[(int)Math.floor(Math.random()*animals.length)]);
        } else {
            result.append(nouns[(int)Math.floor(Math.random()*nouns.length)]);
        }
